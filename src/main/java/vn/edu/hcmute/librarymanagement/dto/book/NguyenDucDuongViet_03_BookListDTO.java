 ...
 *         
 *         Use to tranfer book list info
 * 
 */
public class NguyenDucDuongViet_03_BookListDTO {
	 ...
	 * 
	 */
	public NguyenDucDuongViet_03_BookListDTO() {
	}
	 ...
	 * @param amount
	 */
	public NguyenDucDuongViet_03_BookListDTO(Integer id, String code, String name, NguyenDucDuongViet_03_CategoryDTO category, String publishingFirm,
			Timestamp publishDate, String author, String image, int amount) {
		this.id = id;
		this.code = code;
		this.name = name;
