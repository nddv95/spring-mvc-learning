...
<body class="hold-transition skin-blue sidebar-mini" ng-app="library"
	ng-controller="empBorrowOrderCtrl" ng-init = "init(${orderId})">
	<div class="wrapper">
						...
						<div class="box">
							<div class="box-body">
								...
								<div class="alert alert-info">
									<strong>Có thể chọn mã vạch cho sách đã đặt hoặc thêm sách mới</strong> 
								</div>
								<div class="panel panel-primary">
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/employee/borroworder.js"></script>
