...
<body class="hold-transition skin-blue sidebar-mini" ng-app="library"
	ng-controller="empOrderListCtrl">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Danh sách đặt</li>
				</ol>
			</section>
								...
								<table id="example2" class="table table-bordered table-hover">
									...
									<tbody>
										<tr ng-repeat="order in orders | filter:search">
											...
											<td style="border-right: none;">{{order.user.fullName}}</td>
											<td style="border-left: none;"><a
												href="${pageContext.request.contextPath}/order/{{order.id}}"
												class="btn btn-info btn-sm glyphicon glyphicon-eye-open"></a></td>
											<td>{{order.dateOrder | date:"dd/MM/yyyy 'at' h:mma " }}</td>
											<td>{{order.dateEnd | date:"dd/MM/yyyy 'at' h:mma"}}</td>

										</tr>
										<tr ng-hide="(orders | filter:search).length">
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/employee/orderlist.js"></script>
