...
<body class="hold-transition skin-blue sidebar-mini" ng-app="library"
	ng-controller="empOffsetDetailCtrl" ng-init="init(${borowId})">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="${pageContext.request.contextPath}/offset">Danh
							sách đền bù</a></li>
								...
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<div class="col-md-10">
											<div class="row">
												<div class="col-md-12">
													<label class="col-md-2">Ngày đền bù:</label>{{(offset.offsetDate
													| date:"dd/MM/yyyy") || "Không có dữ liệu"}}
												</div>
											</div>
											<div class="row">
												<div class="col-md-12">
													<label class="col-md-2">Mã mượn sách:</label>{{offset.borrowBookId
													|| "Không có dữ liệu"}}
												</div>
											</div>											
											<div class="row">
											...
											<div class="row">
												<div class="col-md-5">
													<label class="col-md-5">Mã số sinh viên:</label>{{offset.user.username}}
												</div>
												<div class="col-md-6">
													<label class="col-md-4">Tên sinh viên:</label>{{offset.user.fullName}}
												</div>
											</div>
											<div class="row">
												<div class="col-md-5">
													<label class="col-md-5">Ngày sinh:</label>{{(offset.user.dateOfBirth
													| date:"dd/MM/yyyy" )|| "Không có dữ liệu"}}
												</div>
												<div class="col-md-6">
													<label class="col-md-4">Số điện thoại:</label>{{offset.user.phone
													|| "Không có dữ liệu"}}
												</div>
											</div>
											<div class="row">
												<div class="col-md-5">
													<label class="col-md-5">Khoa:</label>{{offset.user.dept ||
													"Không có dữ liệu"}}
												</div>
												<div class="col-md-6">
													<label class="col-md-4">Lớp:</label>{{offset.user.className
													|| "Không có dữ liệu"}}
												</div>
											</div>
											<div class="row">
												<div class="col-md-12">
													<label class="col-md-2">Địa chỉ:</label>{{offset.user.address
													|| "Không có dữ liệu"}}
												</div>
											</div>
										...
										<table class="table table-bordered table-hover">
											<thead>
												<tr>
													...
													<th style="width: 150px">Mã vạch vạch mới</th>
													<th>Tên sách</th>
												</tr>
											</thead>
											<tbody>
												<tr ng-repeat="book in offset.books">
												...
												<tr ng-hide="offset.books.length">
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/employee/offsetdetail.js"></script>
