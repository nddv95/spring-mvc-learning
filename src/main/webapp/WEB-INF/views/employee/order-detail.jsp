...
<body class="hold-transition skin-blue sidebar-mini" ng-app="library"
	ng-controller="empOrderDetailCtrl" ng-init="init(${orderId})">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="${pageContext.request.contextPath}/order">Danh
							sách đặt</a></li>
						...
						<div class="box">
							...
							<div class="box-body">
								<div class="panel panel-primary">
									<div class="panel-heading">Thông tin đặt sách</div>
									<div class="panel-body">
										<div class="col-md-10">
											<div class="row">
												<div class="col-md-5">
													<label class="col-md-5">Mã số sinh viên:</label>{{order.user.username
													|| "Không có dữ liệu"}}
												</div>
												<div class="col-md-6">
													<label class="col-md-4">Tên sinh viên:</label>{{order.user.fullName
													|| "Không có dữ liệu"}}
												</div>
											</div>
											<div class="row">
												<div class="col-md-5">
													<label class="col-md-5">Ngày sinh:</label>{{(order.user.dateOfBirth
													| date:"dd/MM/yyyy" )|| "Không có dữ liệu"}}
												</div>
												<div class="col-md-6">
													<label class="col-md-4">Số điện thoại:</label>{{order.user.phone
													|| "Không có dữ liệu"}}
												</div>
											</div>
											<div class="row">
												<div class="col-md-5">
													<label class="col-md-5">Khoa:</label>{{order.user.dept ||
													"Không có dữ liệu"}}
												</div>
												<div class="col-md-6">
													<label class="col-md-4">Lớp:</label>{{order.user.className
													|| "Không có dữ liệu"}}
												</div>
											</div>
											<div class="row">
												<div class="col-md-12">
													<label class="col-md-2">Địa chỉ:</label>{{order.user.address
													|| "Không có dữ liệu"}}
												</div>
											</div>
											<div class="row">
												<div class="col-md-5">
													<label class="col-md-5">Ngày đặt:</label>{{(order.dateOrder
													| date:"dd/MM/yyyy 'at' h:mma" ) || "Không có dữ liệu"}}
												</div>
												<div class="col-md-6">
													<label class="col-md-4">Hạn lấy sách:</label>{{(order.dateEnd
													| date:"dd/MM/yyyy 'at' h:mma") || "Không có dữ liệu"}}
												</div>
											</div>
											...
											<tbody>
												<tr ng-repeat="book in order.books">
													...
													<td style="border-left: none;"><a href="#"
														...
														<button ng-click="delete(book.id)" type="button"
															class="btn btn-sm btn-danger">
															<span class="glyphicon glyphicon-remove"></span>
														</button></td>
												</tr>
												<tr ng-hide="order.books.length">
													<td colspan="5">Không tìm thấy dữ liệu</td>
												</tr>
											</tbody>
										</table>
										<div style="text-align: center">
											<a href = "${pageContext.request.contextPath}/borrow-book/${orderId}" class="btn btn-primary">Cho
												mượn</a>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/employee/orderdetail.js"></script>
