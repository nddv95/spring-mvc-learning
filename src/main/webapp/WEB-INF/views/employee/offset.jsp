...
<body class="hold-transition skin-blue sidebar-mini" ng-app="library"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>Danh sách đền bù</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Danh sách đền bù</li>
				</ol>
			</section>
							...
							<div class="box-body">
								<div class="form-group pull-right">
									<input type="text" class="search form-control"
										ng-model="search.user.username" placeholder="Tìm theo mã số sinh viên">
								</div>
								<table id="example2" class="table table-bordered table-hover">
									...
									<tbody>
										<tr ng-repeat="offset in offsets | filter:search">
											<td style="text-align: center;">{{$index + 1}}</td>
											<td>{{offset.user.username}}</td>
											<td style="border-right: none;">{{offset.user.fullName}}</td>
											<td style="border-left: none;"><a
												href="${pageContext.request.contextPath}/offset/{{offset.borrowBookId}}"
												class="btn btn-info btn-sm glyphicon glyphicon-eye-open"></a></td>
											<td>{{offset.offsetDate | date:"dd/MM/yyyy"}}</td>
											<td>{{offset.borrowBookId}}</td>

										</tr>
										<tr ng-hide="(offsets | filter:search).length">
								...
								<div class="box-body" style="text-align: center;">
									<a href="${pageContext.request.contextPath}/offset/create" class="btn btn-primary">Thêm mới</a>
								</div>
							</div>
							<!-- /.box-body -->
						</div>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/employee/offset.js"></script>
