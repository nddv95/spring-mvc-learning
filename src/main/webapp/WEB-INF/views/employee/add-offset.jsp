...
<body class="hold-transition skin-blue sidebar-mini" ng-app="library"
	ng-controller="empAddOffsetCtrl">
	<div class="wrapper">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview active"><a
						href="${pageContext.request.contextPath}/offset"> <i
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><a
						href="${pageContext.request.contextPath}/offset">Danh sách đền
							bù</a></li>
						...
						<div class="box">
							<div class="box-body">
								...
								<div class="panel panel-primary">
									<div class="panel-heading">Thông tin đền bù</div>
									<div class="panel-body">
										<div class="col-md-10">
											<div class="row">
												<div class="form-group">
													<label class="col-md-2"
														style="margin-bottom: 0px; padding: 8px">Mã mượn:</label>
													<div class="col-md-6">
														<ui-select ng-model="selected.borrow" theme="bootstrap"
															on-select="onSelectCallback($item, $model)">
														<ui-select-match
															placeholder="Tìm kiếm theo mã số sinh viên hoặc tên sinh viên...">{{$select.selected.id}}</ui-select-match>
														<ui-select-choices
															repeat="item in borrows | filter: $select.search">
														<div ng-bind-html="item.id | highlight: $select.search"></div>
														<small
															ng-bind-html="item.user.username | highlight: $select.search"></small>
														<small
															ng-bind-html="item.user.fullName | highlight: $select.search"></small>
											...
											<div class="row">
												<div class="form-group">
													<label class="col-md-2"
														style="margin-bottom: 0px; padding: 8px">MSSV:</label>
													<div class="col-md-4"
														style="margin-bottom: 0px; padding-top: 8px; padding-bottom: 8px;">{{selected.borrow.user.username||
													...
													<div class="col-md-4"
														...
														selected.borrow.user.fullName|| "Không có dữ liệu"}}</div>
												</div>
											</div>
											<div class="row">
												<div class="form-group">
													<label class="col-md-2"
														...
														sinh:</label>
													<div class="col-md-4"
														style="margin-bottom: 0px; padding-top: 8px; padding-bottom: 8px;">{{(selected.borrow.user.dateOfBirth
														| date:"dd/MM/yyyy" )|| "Không có dữ liệu"}}</div>
													<label class="col-md-2"
														style="margin-bottom: 0px; padding: 8px">CMND:</label>
													<div class="col-md-4"
														style="margin-bottom: 0px; padding-top: 8px; padding-bottom: 8px;">{{selected.borrow.user.indentification
														|| "Không có dữ liệu"}}</div>
												</div>
											</div>
											<div class="row">
												<div class="form-group">
													...
													<div class="col-md-4"
														style="margin-bottom: 0px; padding-top: 8px; padding-bottom: 8px;">{{selected.borrow.user.dept
														|| "Không có dữ liệu"}}</div>
													<label class="col-md-2"
														style="margin-bottom: 0px; padding: 8px">Lớp:</label>
													<div class="col-md-4"
														style="margin-bottom: 0px; padding-top: 8px; padding-bottom: 8px;">{{selected.borrow.user.className
														|| "Không có dữ liệu"}}</div>
												</div>
											</div>
											<div class="row">
												<div class="form-group">
													...
													<div class="col-md-4"
														style="margin-bottom: 0px; padding-top: 8px; padding-bottom: 8px;">{{selected.borrow.user.address
														|| "Không có dữ liệu"}}</div>
													<label class="col-md-2"
														style="margin-bottom: 0px; padding: 8px">Số điện
														thoại:</label>
													<div class="col-md-4"
														style="margin-bottom: 0px; padding-top: 8px; padding-bottom: 8px;">{{selected.borrow.user.phone
														|| "Không có dữ liệu"}}</div>
												</div>
											</div>
											<div class="row">
												...
												<div class="col-md-4">
													<p class="input-group col-md-10">
														<input type="text" class="form-control" disabled
															...
															ng-model="selected.borrow.dateBorrow"
												...
												<div class="col-md-4">
													<p class="input-group col-md-10">
														<input type="text" class="form-control" disabled
															uib-datepicker-popup="dd/MM/yyyy"
															ng-model="selected.borrow.dateReturn"
											...
											<div class="row">
												<label class="col-md-2"
													style="margin-bottom: 0px; padding: 8px">Ngày đền
													bù:</label>
												<div class="col-md-4">
													<p class="input-group col-md-10">
														<input type="text" class="form-control"
															uib-datepicker-popup="dd/MM/yyyy" ng-model="dateOffset"
								...
								<div class="panel panel-primary">
									<div class="panel-heading">Danh sách sách đền bù</div>
									<div class="panel-body">
										<div class="form-group">
											<label class="col-md-1"
												style="margin-bottom: 0px; padding: 8px">Chọn sách:</label>
											<div class="col-md-4">
												<ui-select ng-model="selected.borrowBook" theme="bootstrap">
												<ui-select-match placeholder="Tìm theo tên...">{{$select.selected.book.name}}</ui-select-match>
												<ui-select-choices
													repeat="item in borrowBooks | filter: $select.search">
												<div
													ng-bind-html="item.book.name | highlight: $select.search"></div>
												<small
													ng-bind-html="item.borrow.user.fullName | highlight: $select.search"></small>
												</ui-select-choices> </ui-select>
											</div>
											<label class="col-md-2"
												style="margin-bottom: 0px; padding: 8px; text-align: right">Mã
												vạch mới:</label>
											<div class="col-md-4">
												<input class="form-control" ng-model="code"
													placeholder="Nhập mã vạch mới"
													ng-model-options="{ debounce: 500 }" ng-change="check()">
											</div>
										...
										<table class="table table-bordered table-hover">
											<thead>
												<tr>
													...
													<th style="width: 150px">Mã vạch mới</th>
										...
										<div style="text-align: center">
											<button ng-click="save()" class="btn btn-primary">Chấp
												nhận</button>
											<a href="${pageContext.request.contextPath}/offset"
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/employee/addoffset.js"></script>
