...
<body class="hold-transition skin-blue sidebar-mini" ng-app="library"
								...
								<div>
									<div class="form-group pull-right">
										<input type="text" class="search form-control"
											ng-model="search.name" placeholder="Tên sách">
									</div>
								</div>
								<table id="example2" class="table table-bordered table-hover">
									<thead>
										<tr>
											...
											<th>Thể loại</th>
											<th>Tác giả</th>
											<th width="90px"><a href="${pageContext.request.contextPath}/admin/book/create"
									...
									<tbody>
										<tr ng-repeat="book in books | filter:search">
											...
											<td>{{book.author}}</td>
											<td><a href="${pageContext.request.contextPath}/admin/book/{{book.id}}" class="btn btn-info btn-sm"><span
										...
										<tr ng-hide="(books | filter:search).length">
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/admin/books.js"></script>
