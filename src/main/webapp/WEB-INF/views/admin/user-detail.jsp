...
<body class="hold-transition skin-blue sidebar-mini" ng-app="library"
	ng-controller="adminUserDetailCtrl" ng-init="init(${userId})">
	<div class="wrapper">
									...
									<div class="panel-body">
										<div class="col-md-10">
											<div class="row" style = "margin-top:5px; margin-bottom: 5px">
												<div class="col-md-5">
													<label class="col-md-5">Mã người dùng:</label>{{user.id}}
												</div>
												<div class="col-md-6">
													<label class="col-md-4">Tên đăng nhập:</label>{{user.username}}
												</div>
											</div>
											<div class="row" style = "margin-top:5px; margin-bottom: 5px">
												<div class="col-md-12">
													<label class="col-md-2">Họ và tên:</label>{{user.fullName
													|| "Không có dữ liệu"}}
												</div>
											</div>
											<div class="row" style = "margin-top:5px; margin-bottom: 5px">
												<div class="col-md-5">
													<label class="col-md-5">Ngày sinh:</label>{{(user.dateOfBirth
													| date:"dd/MM/yyyy" )|| "Không có dữ liệu"}}
												</div>
												<div class="col-md-6">
													<label class="col-md-4">CMND:</label>{{user.indentification ||
													"Không có dữ liệu"}}
												</div>
											</div>
											<div class="row" style = "margin-top:5px; margin-bottom: 5px">
												<div class="col-md-5">
													<label class="col-md-5">Khoa:</label>{{user.dept ||
													"Không có dữ liệu"}}
												</div>
												<div class="col-md-6">
													<label class="col-md-4">Lớp:</label>{{user.className
													|| "Không có dữ liệu"}}
												</div>
											</div>
											<div class="row" style = "margin-top:5px; margin-bottom: 5px">
												<div class="col-md-12">
													<label class="col-md-2">Số điện thoại:</label>{{user.phone
													|| "Không có dữ liệu"}}
												</div>
											</div>
											<div class="row" style = "margin-top:5px; margin-bottom: 5px">
												<div class="col-md-12">
													<label class="col-md-2">Địa chỉ:</label>{{user.address
													|| "Không có dữ liệu"}}
												</div>
											</div>
											<div class="row" style = "margin-top:5px; margin-bottom: 5px">
												<div class="col-md-12">
													<label class="col-md-2">Loại tài khoản:</label>{{role[user.role]
													|| "Không có dữ liệu"}}
												</div>
											</div>
										</div>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/admin/userdetail.js"></script>
